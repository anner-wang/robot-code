...
def localize(world, probabilities, measurements, motions, prob_hit, prob_miss, prob_exact, prob_undershoot, prob_overshoot):
    ...
    for k in range(len(measurements)):
        probabilities = move(probabilities, motions[k], prob_exact, prob_undershoot, prob_overshoot)
        probabilities = sense(world, probabilities, measurements[k], prob_hit, prob_miss)
